...
Route::middleware('auth:sanctum')->group(function(){
    ...
    Route::get('order/add_activity/{order}/{activity}', [OrderController::class, 'add_activity'])
                ->name('order.add_activity');
    Route::get('order/remove_activity/{order}/{activity}', [OrderController::class, 'remove_activity'])
                ->name('order.remove_activity');
});
